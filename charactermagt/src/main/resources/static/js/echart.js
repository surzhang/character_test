    ...
    function echarts_1() {
        ...
        $.ajax({
            ...
            success:function (ret) {
                if (ret.code==0) {
                    data[0].value=ret.data.redCount;
                    data[1].value=ret.data.yellowCount;
                    data[2].value=ret.data.blueCount;
                    data[3].value=ret.data.greenCount;
                }
            }
        })
        console.log(data)
        option = {
            ...
            color: ['#F36F8A', '#FFED24', '#0089ff', '#81FA51'],
            legend: { //图例组件，颜色和名字
                x: '70%',
                y: 'center',
                orient: 'vertical',
        ...
        //获取每月测试人数
            $.ajax({
                ...
                success: function (res) {
                    if (res.code === 0) {
                        //metaDate = [res.data.jan, res.data.feb,res.data.mar,res.data.apr,res.data.may,res.data.june,res.data.july,res.data.aug,res.data.sept,res.data.oct,res.data.nov,res.data.dece]
                        jan=res.data.jan;
                        feb=res.data.feb;
                        mar=res.data.mar;
                        apr=res.data.apr;
